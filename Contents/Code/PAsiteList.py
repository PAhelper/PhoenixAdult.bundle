...
searchSites = {
    ...
    282: ('Swallowed', 'https://tour.swallowed.com', '/scenes/'),
    283: ('TrueAnal', 'https://tour.trueanal.com', '/scenes/'),
    284: ('Nympho', 'https://tour.nympho.com', '/scenes/'),
    ...
    767: ('AllAnal', 'https://tour.allanal.com', '/scenes/'),
    ...
    1253: ('AnalOnly', 'https://tour.analonly.com', '/scenes/'),
