...
def search(results, lang, siteNum, searchData):
    ...
    for searchResult in searchResults.xpath('//div[@class="video-details"]'):
        ...
        results.Append(MetadataSearchResult(id='%s|%d|%s' % (curID, siteNum, releaseDate), name='%s [ModelHub/%s]' % (titleNoFormatting, subSite), score=score, lang=lang))
